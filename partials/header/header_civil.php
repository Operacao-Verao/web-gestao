<ul class="nav-links">
  ...
  <li>
    <a href="../../views/niveis_rio/niveis_rio.php"><i class="ph-bold ph-waves"></i><span class="link-name">Níveis dos rios</span></a>
  </li>
</ul>
<ul class="logout-mode">
  <li>
    <a href="../../views/login/login.php">
      ...
      <span class="link-name">Membro da Defesa</span>
    </a>
  </li>
</ul>