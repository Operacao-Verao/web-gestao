...
<body>
    <div class="wrapper">
        ...
        <main>
            <section>
                <p class="section-title">Solicitação de Vistoria Nº<?php echo ' '.$ocorrencia->getId().' - '.formatWeekDay($ocorrencia->getDataOcorrencia()).', '.formatDate($ocorrencia->getDataOcorrencia()) ?></p>
                <article>
                    <div class="item-row">
                        <p class="item-title">Nome: </p>
                        <p><?php echo $civil->getNome(); ?></p>
                    </div>
                    <div class="item-row">
                        <div class="item-row">
                        ...
                        <div class="item-row">
                            ...
                            <p><?php echo $residencial->getNumero(); ?></p>
                        </div>
                    </div>
                    <div class="item-row-2">
                        ...
                        <div class="item-row">
                            ...
                            <p><?php echo $civil->getCelular(); ?></p>
                        </div>
                    </div>
                    <div class="item-row-2">
                        <div class="item-row">
                            <p class="item-title">CPF: </p>
                            <p><?php echo $civil->getCpf(); ?></p>
                        </div>
                        <div class="item-row">
                            <p class="item-title">Email: </p>
                            <p><?php echo $civil->getEmail(); ?></p>
                        </div>
                    </div>
                    <div class="item-row">
                ...
                <div class="data-horario">
                    ...
                    <div>
                        ...
                        <p><?php echo formatDate($current_time); ?></p>
                    </div>
                    <div>
                        <p class="item-title">Horário: </p>
                        <p><?php echo formatTime($current_time); ?></p>
                    </div>
                    <div>
                ...
                <article>
                    ...
                    <div class="item-dadosVistoria">
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getDesmoronamento()?'X':''; ?>) Desmoronamento</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getDeslizamento()?'X':''; ?>) Escorregamento</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getEsgotoEscoamento()?'X':''; ?>) Esgoto/Escoamentos</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getErosao()?'X':''; ?>) Erosão</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getInundacao()?'X':''; ?>) Inundação</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getIncendio()?'X':''; ?>) Incêndio</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getArvores()?'X':''; ?>) Árvores</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getInfiltracaoTrinca()?'X':''; ?>) Infiltrações/Trincas</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getJudicial()?'X':''; ?>) Judicial</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getMonitoramento()?'X':''; ?>) Monitoramento</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getTransito()?'X':''; ?>) Trânsito</p>
                        <p>(<?php echo $dadosDaVistoria!=null && $dadosDaVistoria->getOutros()?'X':''; ?>) Outros</p>
                    </div>
                    <div class="item-row">
        ...
        <p>() Desastre</p>');?>
                    ...
                    <div class="item-row">
                        ...
                        <p><?php echo $relatorio->getEncaminhamento(); ?></p>
                    </div>
                    ...
                    <div class="item-row">
                        ...
                        <p><?php echo $relatorio->getAssunto();?></p>
                    </div>
                    <div class="item-row">
