<?php
	...
	class DAOAlertaRio{
		...
		public function insert($fluviometro, $statusRio, $dataAlertaRio) {
			...
			$insertion->bindValue(":dataAlertaRio", $dataAlertaRio);
		...
		public function remove($alertaRio) {
		...
		public function update($alertaRio) {
